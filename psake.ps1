...
Properties {
    ...
    $ModuleFolder = Split-Path -Path $ENV:BHModuleManifest -Parent
    ...
    $CurrentVersion = [version](Get-Metadata -Path $env:BHModuleManifest)
...
Task Build -Depends UnitTests {
    ...
    Set-ModuleFunctions -Name $env:BHModuleManifest -FunctionsToExport $ExportFunctions
    Update-Metadata -Path $env:BHModuleManifest -PropertyName AliasesToExport -Value $ExportAliases
    ...
    Update-Metadata -Path $env:BHModuleManifest -PropertyName NestedModules -Value $ExportModules
    
    # Bump the module version
    Update-Metadata -Path $env:BHModuleManifest -PropertyName ModuleVersion -Value $BuildVersion
    ...
    Update-Metadata -Path $env:BHModuleManifest -PropertyName ReleaseNotes -Value $ReleaseText
...
Task BuildDocs -depends Test {
    ...
    "Loading Module from $ENV:BHModuleManifest"
    ...
    Import-Module $ENV:BHModuleManifest -force -Global
